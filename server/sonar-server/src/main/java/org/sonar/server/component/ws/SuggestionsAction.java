...
public class SuggestionsAction implements ComponentsWsAction {
  ...
  static final String URL_PARAM_MORE = "more";
  ...
  public void define(WebService.NewController context) {
    ...
    action.createParam(URL_PARAM_MORE)
  ...
  public void handle(Request wsRequest, Response wsResponse) throws Exception {
    String query = wsRequest.param(URL_PARAM_QUERY);
    String more = wsRequest.param(URL_PARAM_MORE);
  ...
  private SuggestionsWsResponse toResponse(List<ComponentHitsPerQualifier> componentsPerQualifiers, @Nullable String warning) {
    ...
    if (!componentsPerQualifiers.isEmpty()) {
      ...
      builder
        .addAllSuggestions(toCategorys(componentsPerQualifiers, componentsByUuids, organizationsByUuids, projectsByUuids))
  ...
  private static List<Category> toCategorys(List<ComponentHitsPerQualifier> componentsPerQualifiers, Map<String, ComponentDto> componentsByUuids,
