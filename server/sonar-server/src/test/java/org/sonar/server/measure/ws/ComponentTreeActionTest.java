...
public class ComponentTreeActionTest {
  ...
  public void fail_when_using_DISTRIB_metrics() {
    ...
    expectedException.expectMessage("Metric types 'DATA' and 'DISTRIB' are not allowed : distrib1, distrib2");
  ...
  public void fail_when_using_DATA_metrics() {
    ...
    expectedException.expect(IllegalArgumentException.class);
    expectedException.expectMessage("Metric types 'DATA' and 'DISTRIB' are not allowed : data1, data2");
